...
(deftest piece-len-test
  (testing "last piece may be shorter"
    (is (= 64 (core/piece-len 100 64 0 2)))
    (is (= 36 (core/piece-len 100 64 1 2))))
  (testing "exact division"
    (is (= 64 (core/piece-len 128 64 1 2)))))
